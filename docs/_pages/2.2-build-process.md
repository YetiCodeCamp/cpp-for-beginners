...
file.s - Assembler code. (hello.s is the assembler code version of our hello program.)
...
There are more suffixes than just those listed that GCC looks for, but these are the 4 used in our programs build process. For a full list consult [the GNU documentation](https://gcc.gnu.org/onlinedocs/gcc/).
