...
<p>There are many, much more detailed, tutorials out there on using Vim that I suggest you consult if you are looking for more advanced functionality. You can start with the documentation found at the [vim.org website](https://www.vim.org/docs.php).</p>  
